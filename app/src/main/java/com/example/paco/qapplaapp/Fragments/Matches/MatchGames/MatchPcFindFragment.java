...
public class MatchPcFindFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.layout_match_find_pc, container, false);
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerFindPc);
