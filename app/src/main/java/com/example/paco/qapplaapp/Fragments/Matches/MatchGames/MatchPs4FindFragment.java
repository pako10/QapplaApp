...
public class MatchPs4FindFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.layout_match_find_ps4, container, false);
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerFindPs4);
